...
interface paths {
    ...
    "/v3/templates": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components$1["schemas"]["TemplateBuildRequestV3"];
                };
            };
            responses: {
                /** @description The build was requested successfully */
                202: {
                    ...
                    content: {
                        "application/json": components$1["schemas"]["TemplateRequestResponseV3"];
                    };
                };
                400: components$1["responses"]["400"];
                401: components$1["responses"]["401"];
    ...
    "/volumes": {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components$1["schemas"]["Volume"][];
                    };
                };
                401: components$1["responses"]["401"];
                500: components$1["responses"]["500"];
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components$1["schemas"]["NewVolume"];
                };
            };
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": components$1["schemas"]["VolumeAndToken"];
                    };
                };
                400: components$1["responses"]["400"];
                401: components$1["responses"]["401"];
    ...
    "/volumes/{volumeID}": {
        ...
        get: {
            parameters: {
                ...
                header?: never;
                path: {
                    volumeID: components$1["parameters"]["volumeID"];
                };
                cookie?: never;
            };
            requestBody?: never;
...
interface components$1 {
    schemas: {
        ...
        BuildStatusReason: {
             ...
             * @default []
             */
            logEntries?: components$1["schemas"]["BuildLogEntry"][];
        ...
        CreatedAccessToken: {
             ...
             */
            id: string;
            mask: components$1["schemas"]["IdentifierMaskingDetails"];
        ...
        CreatedTeamAPIKey: {
             ...
             */
            createdAt: string;
            createdBy?: components$1["schemas"]["TeamUser"] | null;
            /**
             * Format: uuid
        ...
        FromImageRegistry: components$1["schemas"]["AWSRegistry"] | components$1["schemas"]["GCPRegistry"] | components$1["schemas"]["GeneralRegistry"];
        GCPRegistry: {
        ...
        ListedSandbox: {
             ...
             */
            clientID: string;
            cpuCount: components$1["schemas"]["CPUCount"];
            diskSizeMB: components$1["schemas"]["DiskSizeMB"];
            /**
             * Format: date-time
             * @description Time when the sandbox will expire
             */
            endAt: string;
            envdVersion: components$1["schemas"]["EnvdVersion"];
            memoryMB: components$1["schemas"]["MemoryMB"];
            metadata?: components$1["schemas"]["SandboxMetadata"];
            ...
            templateID: string;
            volumeMounts?: components$1["schemas"]["SandboxVolumeMount"][];
        };
        /**
        ...
        NewSandbox: {
             ...
             */
            autoPause?: boolean;
            autoResume?: components$1["schemas"]["SandboxAutoResumeConfig"];
            envVars?: components$1["schemas"]["EnvVars"];
            mcp?: components$1["schemas"]["Mcp"];
            metadata?: components$1["schemas"]["SandboxMetadata"];
            network?: components$1["schemas"]["SandboxNetworkConfig"];
        ...
        Node: {
            ...
            id: string;
            machineInfo: components$1["schemas"]["MachineInfo"];
            metrics: components$1["schemas"]["NodeMetrics"];
            /**
             * Format: uint32
            ...
            status: components$1["schemas"]["NodeStatus"];
        ...
        NodeMetrics: {
            ...
            disks: components$1["schemas"]["DiskMetrics"][];
            /**
             * Format: uint64
        ...
        SandboxAutoResumeConfig: {
            enabled: components$1["schemas"]["SandboxAutoResumeEnabled"];
        };
        /**
        ...
        SandboxDetail: {
            ...
            envdAccessToken?: string;
            envdVersion: components$1["schemas"]["EnvdVersion"];
            lifecycle?: components$1["schemas"]["SandboxLifecycle"];
            memoryMB: components$1["schemas"]["MemoryMB"];
            metadata?: components$1["schemas"]["SandboxMetadata"];
            network?: components$1["schemas"]["SandboxNetworkConfig"];
            /** @description Identifier of the sandbox */
        ...
        SandboxesWithMetrics: {
            sandboxes: {
                [key: string]: components$1["schemas"]["SandboxMetric"];
            };
        };
        ...
        SandboxLifecycle: {
            ...
            autoResume: boolean;
            onTimeout: components$1["schemas"]["SandboxOnTimeout"];
        };
        ...
        SandboxLogs: {
            ...
            logEntries: components$1["schemas"]["SandboxLogEntry"][];
            /** @description Logs of the sandbox */
            logs: components$1["schemas"]["SandboxLog"][];
        };
        SandboxLogsV2Response: {
             ...
             * @default []
             */
            logs: components$1["schemas"]["SandboxLogEntry"][];
        };
        SandboxMetadata: {
            [key: string]: string;
        };
        ...
        Template: {
            ...
            buildID: string;
            buildStatus: components$1["schemas"]["TemplateBuildStatus"];
            cpuCount: components$1["schemas"]["CPUCount"];
            /**
             * Format: date-time
        ...
        TemplateBuild: {
            ...
            finishedAt?: string;
            memoryMB: components$1["schemas"]["MemoryMB"];
            status: components$1["schemas"]["TemplateBuildStatus"];
            /**
             * Format: date-time
        ...
        TemplateBuildInfo: {
             ...
             */
            logs: string[];
            reason?: components$1["schemas"]["BuildStatusReason"];
            status: components$1["schemas"]["TemplateBuildStatus"];
            /** @description Identifier of the template */
            templateID: string;
        };
        TemplateBuildLogsResponse: {
             ...
             * @default []
             */
            logs: components$1["schemas"]["BuildLogEntry"][];
        };
        ...
        TemplateBuildStartV2: {
            ...
            fromImage?: string;
            fromImageRegistry?: components$1["schemas"]["FromImageRegistry"];
             ...
             * @default []
             */
            steps?: components$1["schemas"]["TemplateStep"][];
        };
        /**
        ...
        TemplateWithBuilds: {
            ...
            builds: components$1["schemas"]["TemplateBuild"][];
            /**
             * Format: date-time
             * @description Time when the template was created
             */
 ...
 */
type VolumeEntryStat = Omit<components['schemas']['VolumeEntryStat'], 'atime' | 'mtime' | 'ctime' | 'type'> & {
    /**
 ...
 */
type VolumeWriteOptions = VolumeMetadataOptions & {
    /**
...
declare class Volume {
     ...
     */
    constructor(volumeId: string, name: string, token: string, domain?: string, debug?: boolean);
    /**
     * Create a new volume.
     *
     ...
     * @param opts connection options.
     */
    makeDir(path: string, opts?: VolumeWriteOptions & VolumeApiOpts): Promise<VolumeEntryStat>;
    /**
     * Get information about a file or directory.
     *
     ...
     */
    updateMetadata(path: string, metadata: VolumeMetadataOptions, opts?: VolumeApiOpts): Promise<VolumeEntryStat>;
    /**
     * Read file content as a `string`.
     *
     * You can pass `text`, `bytes`, `blob`, or `stream` to `opts.format` to change the return type.
     ...
     * @returns file content as string
     */
    readFile(path: string, opts?: VolumeApiOpts & {
        format?: 'text';
    }): Promise<string>;
    /**
     * Read file content as a `Uint8Array`.
     ...
     * @returns information about the written file
     */
    writeFile(path: string, data: string | ArrayBuffer | Blob | ReadableStream<Uint8Array>, opts?: VolumeWriteOptions & VolumeApiOpts): Promise<VolumeEntryStat>;
    /**
     * Remove a file or directory.
     *
 ...
 */
interface SnapshotListOpts extends SandboxApiOpts {
    /**
...
declare abstract class BasePaginator<T> {
 ...
 * ```
 */
declare class SandboxPaginator extends BasePaginator<SandboxInfo> {
    private query;
 ...
 * ```
 */
declare class SnapshotPaginator extends BasePaginator<SnapshotInfo> {
...
export { ALL_TRAFFIC, ApiClient, AuthenticationError, BuildError, type BuildInfo, type BuildOptions, type BuildStatusReason, type CommandConnectOpts, CommandExitError, CommandHandle, type CommandRequestOpts, type CommandResult, type CommandStartOpts, Commands, ConnectionConfig, type ConnectionOpts, type CopyItem, type EntryInfo, FileNotFoundError, FileType, FileUploadError, Filesystem, type FilesystemEvent, FilesystemEventType, type FilesystemReadOpts, type FilesystemWriteOpts, type GetBuildStatusOptions, Git, type GitAddOpts, GitAuthError, type GitBranches, type GitCloneOpts, type GitCommitOpts, type GitConfigOpts, type GitConfigScope, type GitDangerouslyAuthenticateOpts, type GitDeleteBranchOpts, type GitFileStatus, type GitInitOpts, type GitPullOpts, type GitPushOpts, type GitRemoteAddOpts, type GitRequestOpts, type GitStatus, GitUpstreamError, InvalidArgumentError, LogEntry, LogEntryEnd, type LogEntryLevel, LogEntryStart, type Logger, type McpServer$1 as McpServer, type McpServerName, NotEnoughSpaceError, NotFoundError, type ProcessInfo, Pty, type PtyOutput, RateLimitError, ReadyCmd, Sandbox, type SandboxApiOpts, type SandboxBetaCreateOpts, type SandboxConnectOpts, SandboxError, type SandboxInfo, type SandboxInfoLifecycle, type SandboxLifecycle, type SandboxListOpts, type SandboxMetrics, type SandboxMetricsOpts, type SandboxNetworkOpts, SandboxNotFoundError, type SandboxOpts, SandboxPaginator, type SandboxState, type SnapshotInfo, type SnapshotListOpts, SnapshotPaginator, type Stderr, type Stdout, Template, TemplateBase, type TemplateBuildStatus, type TemplateBuildStatusResponse, type TemplateBuilder, type TemplateClass, TemplateError, type TemplateTag, type TemplateTagInfo, TimeoutError, type Username, Volume, type VolumeAndToken, type VolumeApiOpts, VolumeConnectionConfig, type VolumeEntryStat, VolumeError, VolumeFileType, type VolumeInfo, type VolumeMetadataOptions, type VolumeWriteOptions, WatchHandle, type WriteInfo, type components$1 as components, Sandbox as default, defaultBuildLogger, getSignature, type paths, waitForFile, waitForPort, waitForProcess, waitForTimeout, waitForURL };
