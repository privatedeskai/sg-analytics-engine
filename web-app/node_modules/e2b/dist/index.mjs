...
var DEFAULT_ERROR_MAP2 = {
  [Code2.InvalidArgument]: (message) => new InvalidArgumentError(message),
  [Code2.Unauthenticated]: (message) => new AuthenticationError(message),
  [Code2.NotFound]: (message) => new NotFoundError(message),
  [Code2.Unavailable]: formatSandboxTimeoutError,
  [Code2.Canceled]: (message) => new TimeoutError(
  ...
  [Code2.DeadlineExceeded]: (message) => new TimeoutError(
...
var FILESYSTEM_RPC_ERROR_MAP = {
  [Code3.NotFound]: (message) => new FileNotFoundError(message)
};
...
var Filesystem2 = class {
  ...
  async write(pathOrFiles, dataOrOpts, opts) {
    ...
    const supportsOctetStream = compareVersions2(this.envdApi.version, ENVD_OCTET_STREAM_UPLOAD) >= 0;
...
var Pty = class {
  ...
  constructor(transport, connectionConfig, metadata) {
    ...
    this.rpc = createClient5(Process, this.transport);
...
var Commands = class {
  constructor(transport, connectionConfig, metadata) {
    ...
    this.rpc = createClient6(Process, transport);
    this.envdVersion = metadata.version;
  }
  /**
   * @hidden
  ...
  get supportsStdinClose() {
    return compareVersions3(this.envdVersion, ENVD_ENVD_CLOSE) >= 0;
  }
  /**
